...
const projects = [
	...
	},
	{
		...
		title: "Project 4",
		description:
			"Currently building Real Estate web applications using React , Node.js , Express , and Bootstrap . Actively developing RESTful APIs using Express for smooth data ﬂow between frontend and backend. Implemented ﬁlter functionality for users to search properties by location, price, and type. Managing dynamic state with React hooks and improving frontend functionality.",
		images: [
